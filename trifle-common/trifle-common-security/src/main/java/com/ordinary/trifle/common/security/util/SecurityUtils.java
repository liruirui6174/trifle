...
package com.ordinary.trifle.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public TrifleUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof TrifleUser) {
			return (TrifleUser) principal;
		}
		return null;
	}
