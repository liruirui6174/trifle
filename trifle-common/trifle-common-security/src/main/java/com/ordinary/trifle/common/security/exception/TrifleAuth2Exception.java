...
public class TrifleAuth2Exception extends OAuth2Exception {

	@Getter
	private String errorCode;

	public TrifleAuth2Exception(String msg) {
		super(msg);
	}

	public TrifleAuth2Exception(String msg, String errorCode) {
		super(msg);
