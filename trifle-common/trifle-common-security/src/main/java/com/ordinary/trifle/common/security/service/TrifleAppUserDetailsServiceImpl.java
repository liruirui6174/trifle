...
import com.ordinary.trifle.admin.api.feign.RemoteUserService;
...
public class TrifleAppUserDetailsServiceImpl implements TrifleUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (TrifleUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(TrifleUser trifleUser) {
		return this.loadUserByUsername(trifleUser.getPhone());
	}
