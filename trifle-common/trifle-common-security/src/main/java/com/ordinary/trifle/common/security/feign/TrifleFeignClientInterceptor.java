...
package com.ordinary.trifle.common.security.feign;
 ...
 */
@Slf4j
public class TrifleFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public TrifleFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
