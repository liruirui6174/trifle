...
package com.ordinary.trifle.codegen;

import com.ordinary.trifle.common.datasource.annotation.EnableDynamicDataSource;
...
public class TrifleCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(TrifleCodeGenApplication.class, args);
	}
